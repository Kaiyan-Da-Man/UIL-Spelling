	...
	class t {
		...
		then(f, i) {
			...
			let g = new h(oe),
				w = n.current;
			return (
				this[q] == M ? this[R].push(w, g, f, i) : Q(this, w, g, f, i), g
			);
		}
		catch(f) {
			...
			let g = n.current;
			return (
				this[q] == M ? this[R].push(g, h, f, f) : Q(this, g, h, f, f), h
			);
		}
	}
	(t.resolve = t.resolve),
				...
				a.forEach(function (m) {
					...
					try {
						if (Z.hasOwnProperty(m)) {
							...
							O && O.value
								? ((O.value = e.wrapWithCurrentZone(
										O.value,
										I,
									)),
									e._redefineProperty(b.prototype, m, O))
								: Z[m] &&
									(Z[m] = e.wrapWithCurrentZone(Z[m], I));
